...
void HardcodedConditions::GetTtaggingEff2016APV(double pt, double *eff, std::string sample, int massIndex){
   ...
   double x53x53Eff[12][Nbin] = {//X53X53
     ...
     {1.000, 1.000, 0.895, 0.875, 0.864, 0.952, 0.929, 0.934, 0.923, 0.959, 0.958},
     };
    double x53x53EffH[49][Nbin] = {//X53X53
     ...
     {0.7, 0.8, 0.87, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.86, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.87, 0.86, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.87, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.87, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.87, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.86, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
...
void HardcodedConditions::GetTtaggingEff2016(double pt, double *eff, std::string sample, int massIndex){
   ...
   double STEff[Nbin] = {0.521, 0.792, 0.871, 0.894, 0.904, 0.905, 0.919, 0.915, 0.907, 0.906, 0.940}; 
    ...
    double x53x53Eff[12][Nbin] = {//X53X53
     ...
     {0.7, 0.8, 0.88, 0.9, 0.9, 0.9, 0.93, 0.94, 0.94, 0.94, 0.94},
     };
    double x53x53EffH[49][Nbin] = {//X53X53
     ...
     {0.7, 0.8, 0.87, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.86, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.85, 0.86, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.87, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.87, 0.89, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.87, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.86, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.85, 0.86, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.87, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
...
void HardcodedConditions::GetTtaggingEff2017(double pt, double *eff, std::string sample, int massIndex){
   ...
   double STEff[Nbin] = {0.500, 0.779, 0.862, 0.890, 0.901, 0.911, 0.912, 0.910, 0.922, 0.903, 0.908};
    ...
    double x53x53Eff[12][Nbin] = {//X53X53
     ...
     {0.725, 0.816, 0.846, 0.895, 0.906, 0.908, 0.921, 0.929, 0.939, 0.943, 0.937},
     };
    ...
    double x53x53EffH[49][Nbin] = {//X53X53
     ...
     {0.7, 0.8, 0.86, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.65, 0.8, 0.84, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.85, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.86, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.86, 0.8, 0.89, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.86, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.65, 0.8, 0.84, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.85, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.86, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
...
void HardcodedConditions::GetTtaggingEff2018(double pt, double *eff, std::string sample, int massIndex){
   ...
   double STEff[Nbin] = {0.496, 0.777, 0.864, 0.890, 0.899, 0.907, 0.911, 0.915, 0.918, 0.912, 0.891}; 
    ...
    double x53x53Eff[12][Nbin] = {//X53X53
     ...
     {0.7, 0.8, 0.86, 0.89, 0.9, 0.9, 0.9, 0.9, 0.94, 0.94, 0.94},
     };
    ...
    double x53x53EffH[49][Nbin] = {//X53X53
     ...
     {0.7, 0.8, 0.8, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.66, 0.8, 0.84, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.85, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.86, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.85, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
     {0.7, 0.8, 0.8, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9, 0.9},
...
void HardcodedConditions::GetWtaggingEff2016APV(double pt, double *eff, std::string sample, int massIndex){
    ...
    double x53x53Eff[12][NbinS] = {//X53X53
       ...
       {0.167, 0.211, 0.305, 0.229, 0.359, 0.331, 0.392, 0.448, 0.381, 0.490, 0.541, 0.601, 0.549, 0.593}, 
      };     
      //I don't use these
    double x53x53EffH[49][NbinS] = {//X53X53
...
void HardcodedConditions::GetWtaggingEff2016(double pt, double *eff, std::string sample, int massIndex){
    ...
    double x53x53Eff[12][NbinS] = {//X53X53
       ...
       {0.2, 0.3, 0.3, 0.3, 0.3, 0.37, 0.4, 0.4, 0.47, 0.5, 0.6, 0.6, 0.64, 0.66},
      };     
    double x53x53EffH[49][NbinS] = {//X53X53
...
void HardcodedConditions::GetWtaggingEff2017(double pt, double *eff, std::string sample, int massIndex){
    ...
    double x53x53Eff[12][NbinS] = {//X53X53
       ...
       {0.164, 0.282, 0.298, 0.292, 0.317, 0.348, 0.375, 0.392, 0.442, 0.490, 0.539, 0.588, 0.625, 0.660},
      };     
...
void HardcodedConditions::GetWtaggingEff2018(double pt, double *eff, std::string sample, int massIndex){
    ...
    double x53x53Eff[12][NbinS] = {//X53X53
       ...
       {0.2, 0.3, 0.3, 0.3, 0.3, 0.37, 0.4, 0.44, 0.48, 0.5, 0.56, 0.6, 0.65, 0.68},//1600R
      };    
...
{
  if      (year=="2016APV") return GetElectronIdSF2016(pt, eta, shift);
...
double HardcodedConditions::GetMuonTriggerSF2016APV(double pt, double eta){
  if ( pt < 30.0 ) {
    if ( fabs(eta) < 0.9 ) return 0.95717225;
    else if ( fabs(eta) < 1.2 ) return 0.94492131;
    else if ( fabs(eta) < 2.1 ) return 0.98972724;
    else return 0.91703538; }
  else if ( pt < 40.0 ) {
    if ( fabs(eta) < 0.9 ) return 0.966006;
    else if ( fabs(eta) < 1.2 ) return 0.95600859;
    else if ( fabs(eta) < 2.1 ) return 0.99303014;
    else return 0.9442141; }
  else if ( pt < 50.0 ) {
    if ( fabs(eta) < 0.9 ) return 0.96893105;
    else if ( fabs(eta) < 1.2 ) return 0.95901162;
    else if ( fabs(eta) < 2.1 ) return 0.99435368;
    else return 0.9568139; }
  else if ( pt < 60.0 ) {
    if ( fabs(eta) < 0.9 ) return 0.9702976;
    else if ( fabs(eta) < 1.2 ) return 0.95915264;
    else if ( fabs(eta) < 2.1 ) return 0.99249891;
    else return 0.94880305; }
  else if ( pt < 120.0 ) {
    if ( fabs(eta) < 0.9 ) return 0.97014199;
    else if ( fabs(eta) < 1.2 ) return 0.96075815;
    else if ( fabs(eta) < 2.1 ) return 0.98981584;
    else return 0.9550548; }
  else {
    if ( fabs(eta) < 0.9 ) return 0.96850817;
    else if ( fabs(eta) < 1.2 ) return 0.95554657;
    else if ( fabs(eta) < 2.1 ) return 0.98403387;
    else return 0.89790203; }
}

// using MUON JSON UL SF with WP: NUM_IsoMu24_or_IsoTkMu24_DEN_CutBasedIdTight_and_PFIsoTight
double HardcodedConditions::GetMuonTriggerSF2016(double pt, double eta){
  if ( pt < 30.0 ) {
    if ( fabs(eta) < 0.9 ) return 0.95628407;
    else if ( fabs(eta) < 1.2 ) return 0.95094275;
    else if ( fabs(eta) < 2.1 ) return 0.9811043;
    else return 0.91266799; }
  else if ( pt < 40.0 ) {
    if ( fabs(eta) < 0.9 ) return 0.96791577;
    else if ( fabs(eta) < 1.2 ) return 0.96359507;
    else if ( fabs(eta) < 2.1 ) return 0.9902429;
    else return 0.94378576; }
  else if ( pt < 50.0 ) {
    if ( fabs(eta) < 0.9 ) return 0.97332898;
    else if ( fabs(eta) < 1.2 ) return 0.96753626;
    else if ( fabs(eta) < 2.1 ) return 0.9953254;
    else return 0.95393064; }
  else if ( pt < 60.0 ) {
    if ( fabs(eta) < 0.9 ) return 0.97456854;
    else if ( fabs(eta) < 1.2 ) return 0.96834233;
    else if ( fabs(eta) < 2.1 ) return 0.99659354;
    else return 0.96477865; }
  else if ( pt < 120.0 ) {
    if ( fabs(eta) < 0.9 ) return 0.97453175;
    else if ( fabs(eta) < 1.2 ) return 0.96675794;
    else if ( fabs(eta) < 2.1 ) return 0.99410449;
    else return 0.962327; }
  else {
    if ( fabs(eta) < 0.9 ) return 0.97864033;
    else if ( fabs(eta) < 1.2 ) return 0.96128835;
    else if ( fabs(eta) < 2.1 ) return 0.99891956;
    else return 1.00654305; }
}
...
double HardcodedConditions::GetMuonTriggerSF2017(double pt, double eta){
  if ( pt < 30.0 ) {
    if ( fabs(eta) < 0.9 ) return 0.96736934;
    else if ( fabs(eta) < 1.2 ) return 0.95405039;
    else if ( fabs(eta) < 2.1 ) return 1.00759538;
    else return 0.86259712; }
  else if ( pt < 40.0 ) {
    if ( fabs(eta) < 0.9 ) return 0.97152556;
    else if ( fabs(eta) < 1.2 ) return 0.94982041;
    else if ( fabs(eta) < 2.1 ) return 1.01435628;
    else return 0.94626364; }
  else if ( pt < 50.0 ) {
    if ( fabs(eta) < 0.9 ) return 0.97258937;
    else if ( fabs(eta) < 1.2 ) return 0.95042462;
    else if ( fabs(eta) < 2.1 ) return 1.01208135;
    else return 0.98301873; }
  else if ( pt < 60.0 ) {
    if ( fabs(eta) < 0.9 ) return 0.97089293;
    else if ( fabs(eta) < 1.2 ) return 0.9491643;
    else if ( fabs(eta) < 2.1 ) return 1.0087067;
    else return 0.9978137; }
  else if ( pt < 120.0 ) {
    if ( fabs(eta) < 0.9 ) return 0.96881591;
    else if ( fabs(eta) < 1.2 ) return 0.94172288;
    else if ( fabs(eta) < 2.1 ) return 1.00635533;
    else return 1.00042853; }
  else {
    if ( fabs(eta) < 0.9 ) return 0.97026044;
    else if ( fabs(eta) < 1.2 ) return 0.93832961;
    else if ( fabs(eta) < 2.1 ) return 1.00021146;
    else return 1.02772973; }
}
...
double HardcodedConditions::GetMuonTriggerSF2018(double pt, double eta){
  if ( pt < 30.0 ) {
    if ( fabs(eta) < 0.9 ) return 0.97177307;
    else if ( fabs(eta) < 1.2 ) return 0.95959067;
    else if ( fabs(eta) < 2.1 ) return 1.00710781;
    else return 0.95464521; }
  else if ( pt < 40.0 ) {
    if ( fabs(eta) < 0.9 ) return 0.97694585;
    else if ( fabs(eta) < 1.2 ) return 0.96946;
    else if ( fabs(eta) < 2.1 ) return 1.00613412;
    else return 0.98554048; }
  else if ( pt < 50.0 ) {
    if ( fabs(eta) < 0.9 ) return 0.9775599;
    else if ( fabs(eta) < 1.2 ) return 0.97182358;
    else if ( fabs(eta) < 2.1 ) return 1.00509836;
    else return 0.99840574; }
  else if ( pt < 60.0 ) {
    if ( fabs(eta) < 0.9 ) return 0.97695823;
    else if ( fabs(eta) < 1.2 ) return 0.97109532;
    else if ( fabs(eta) < 2.1 ) return 1.00459064;
    else return 1.00707493; }
  else if ( pt < 120.0 ) {
    if ( fabs(eta) < 0.9 ) return 0.97661711;
    else if ( fabs(eta) < 1.2 ) return 0.96887862;
    else if ( fabs(eta) < 2.1 ) return 1.00237141;
    else return 1.00931164; }
  else {
    if ( fabs(eta) < 0.9 ) return 0.97209855;
    else if ( fabs(eta) < 1.2 ) return 0.96073892;
    else if ( fabs(eta) < 2.1 ) return 1.00193839;
    else return 1.00913406; }
}
...
bool HardcodedConditions::GetJetVetoMap2016( double eta, double phi ){
  if( (eta >= -3.664 && eta <-3.489) && (phi >= -3.0543261909902775 && phi < -2.9670597283905553) ) return true;
  else if( (eta >= -3.664 && eta <-3.489) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= -3.489 && eta <-3.314) && (phi >= 1.9198621771938889 && phi < 2.0071286397936112) ) return true;
  else if( (eta >= -3.489 && eta <-3.314) && (phi >= 3.0543261909902775 && phi < 3.1415926536) ) return true;
  else if( (eta >= -2.65 && eta <-2.5) && (phi >= 1.9198621771938889 && phi < 2.0071286397936112) ) return true;
  else if( (eta >= -2.5 && eta <-2.322) && (phi >= -1.0471975511966667 && phi < -0.9599310885969444) ) return true;
  else if( (eta >= -1.83 && eta <-1.74) && (phi >= 3.0543261909902775 && phi < 3.1415926536) ) return true;
  else if( (eta >= -1.305 && eta <-1.218) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= -1.218 && eta <-1.131) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= -1.131 && eta <-1.044) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= -1.044 && eta <-0.957) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= -0.957 && eta <-0.87) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= -0.87 && eta <-0.783) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= -0.783 && eta <-0.696) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= -0.696 && eta <-0.609) && (phi >= 0.3490658503988889 && phi < 0.4363323129986111) ) return true;
  else if( (eta >= -0.696 && eta <-0.609) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= -0.609 && eta <-0.522) && (phi >= 0.3490658503988889 && phi < 0.4363323129986111) ) return true;
  else if( (eta >= -0.609 && eta <-0.522) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= -0.522 && eta <-0.435) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= -0.522 && eta <-0.435) && (phi >= 0.5235987755983333 && phi < 0.6108652381980555) ) return true;
  else if( (eta >= -0.435 && eta <-0.348) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= -0.435 && eta <-0.348) && (phi >= 0.5235987755983333 && phi < 0.6108652381980555) ) return true;
  else if( (eta >= -0.348 && eta <-0.261) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= -0.261 && eta <-0.174) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= -0.174 && eta <-0.087) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= -0.087 && eta <0.0) && (phi >= -1.6580627893947222 && phi < -1.570796326795) ) return true;
  else if( (eta >= -0.087 && eta <0.0) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= 0.0 && eta <0.087) && (phi >= -2.443460952792222 && phi < -2.3561944901925) ) return true;
  else if( (eta >= 0.0 && eta <0.087) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= 0.0 && eta <0.087) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= 0.087 && eta <0.174) && (phi >= -2.443460952792222 && phi < -2.3561944901925) ) return true;
  else if( (eta >= 0.087 && eta <0.174) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= 0.174 && eta <0.261) && (phi >= -2.443460952792222 && phi < -2.3561944901925) ) return true;
  else if( (eta >= 0.174 && eta <0.261) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= 0.261 && eta <0.348) && (phi >= -2.443460952792222 && phi < -2.3561944901925) ) return true;
  else if( (eta >= 0.261 && eta <0.348) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= 0.348 && eta <0.435) && (phi >= -2.443460952792222 && phi < -2.3561944901925) ) return true;
  else if( (eta >= 0.348 && eta <0.435) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= 0.435 && eta <0.522) && (phi >= -2.443460952792222 && phi < -2.3561944901925) ) return true;
  else if( (eta >= 0.435 && eta <0.522) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= 0.522 && eta <0.609) && (phi >= -2.443460952792222 && phi < -2.3561944901925) ) return true;
  else if( (eta >= 0.522 && eta <0.609) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= 0.609 && eta <0.696) && (phi >= -2.443460952792222 && phi < -2.3561944901925) ) return true;
  else if( (eta >= 0.609 && eta <0.696) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= 0.696 && eta <0.783) && (phi >= -2.443460952792222 && phi < -2.3561944901925) ) return true;
  else if( (eta >= 0.696 && eta <0.783) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= 0.783 && eta <0.87) && (phi >= -2.443460952792222 && phi < -2.3561944901925) ) return true;
  else if( (eta >= 0.783 && eta <0.87) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= 0.87 && eta <0.957) && (phi >= -2.443460952792222 && phi < -2.3561944901925) ) return true;
  else if( (eta >= 0.87 && eta <0.957) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= 0.957 && eta <1.044) && (phi >= -2.443460952792222 && phi < -2.3561944901925) ) return true;
  else if( (eta >= 0.957 && eta <1.044) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= 1.044 && eta <1.131) && (phi >= -2.443460952792222 && phi < -2.3561944901925) ) return true;
  else if( (eta >= 1.044 && eta <1.131) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= 1.131 && eta <1.218) && (phi >= -2.443460952792222 && phi < -2.3561944901925) ) return true;
  else if( (eta >= 1.131 && eta <1.218) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= 1.218 && eta <1.305) && (phi >= -2.443460952792222 && phi < -2.3561944901925) ) return true;
  else if( (eta >= 1.218 && eta <1.305) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= 2.043 && eta <2.172) && (phi >= -1.6580627893947222 && phi < -1.570796326795) ) return true;
  else if( (eta >= 2.043 && eta <2.172) && (phi >= -1.570796326795 && phi < -1.4835298641952777) ) return true;
  else if( (eta >= 2.322 && eta <2.5) && (phi >= -1.4835298641952777 && phi < -1.3962634015955555) ) return true;
  else if( (eta >= 2.5 && eta <2.65) && (phi >= -0.5235987755983333 && phi < -0.4363323129986111) ) return true;
  else if( (eta >= 2.5 && eta <2.65) && (phi >= -0.3490658503988889 && phi < -0.26179938779916667) ) return true;
  else if( (eta >= 2.853 && eta <2.964) && (phi >= 0.6981317007977778 && phi < 0.7853981633975) ) return true;
  else if( (eta >= 2.853 && eta <2.964) && (phi >= 2.443460952792222 && phi < 2.5307274153919446) ) return true;
  else if( (eta >= 2.853 && eta <2.964) && (phi >= 2.5307274153919446 && phi < 2.6179938779916667) ) return true;
  else if( (eta >= 2.964 && eta <3.139) && (phi >= -2.9670597283905553 && phi < -2.879793265790833) ) return true;
  else if( (eta >= 2.964 && eta <3.139) && (phi >= -2.879793265790833 && phi < -2.792526803191111) ) return true;
  else if( (eta >= 2.964 && eta <3.139) && (phi >= 1.1344640137963888 && phi < 1.221730476396111) ) return true;
  else if( (eta >= 2.964 && eta <3.139) && (phi >= 1.221730476396111 && phi < 1.3089969389958334) ) return true;
  else if( (eta >= 2.964 && eta <3.139) && (phi >= 1.3962634015955555 && phi < 1.4835298641952777) ) return true;
  else if( (eta >= 3.139 && eta <3.314) && (phi >= -2.9670597283905553 && phi < -2.879793265790833) ) return true;
  else if( (eta >= 3.139 && eta <3.314) && (phi >= -2.879793265790833 && phi < -2.792526803191111) ) return true;
  else if( (eta >= 3.314 && eta <3.489) && (phi >= -2.9670597283905553 && phi < -2.879793265790833) ) return true;
  else if( (eta >= 3.314 && eta <3.489) && (phi >= -2.879793265790833 && phi < -2.792526803191111) ) return true;
  else if( (eta >= 3.314 && eta <3.489) && (phi >= 0.6108652381980555 && phi < 0.6981317007977778) ) return true;
  else if( (eta >= 3.489 && eta <3.664) && (phi >= -2.9670597283905553 && phi < -2.879793265790833) ) return true;
  else if( (eta >= 3.489 && eta <3.664) && (phi >= -2.879793265790833 && phi < -2.792526803191111) ) return true;
  else if( (eta >= 3.489 && eta <3.664) && (phi >= 2.6179938779916667 && phi < 2.705260340591389) ) return true;
  else if( (eta >= 3.664 && eta <3.839) && (phi >= -2.9670597283905553 && phi < -2.879793265790833) ) return true;
  else if( (eta >= 3.664 && eta <3.839) && (phi >= -2.879793265790833 && phi < -2.792526803191111) ) return true;
  else return false;
...
bool HardcodedConditions::GetJetVetoMap2017( double eta, double phi ){
  if( (eta >= -2.964 && eta <-2.853) && (phi >= 2.1816615649930555 && phi < 2.2689280275927777) ) return true;
  else if( (eta >= -2.964 && eta <-2.853) && (phi >= 2.2689280275927777 && phi < 2.3561944901925) ) return true;
  else if( (eta >= -2.964 && eta <-2.853) && (phi >= 2.3561944901925 && phi < 2.443460952792222) ) return true;
  else if( (eta >= -2.964 && eta <-2.853) && (phi >= 2.9670597283905553 && phi < 3.0543261909902775) ) return true;
  else if( (eta >= -2.853 && eta <-2.65) && (phi >= 2.1816615649930555 && phi < 2.2689280275927777) ) return true;
  else if( (eta >= -2.853 && eta <-2.65) && (phi >= 2.2689280275927777 && phi < 2.3561944901925) ) return true;
  else if( (eta >= -2.853 && eta <-2.65) && (phi >= 2.9670597283905553 && phi < 3.0543261909902775) ) return true;
  else if( (eta >= -1.93 && eta <-1.83) && (phi >= -0.26179938779916667 && phi < -0.17453292519944444) ) return true;
  else if( (eta >= -1.93 && eta <-1.83) && (phi >= -0.17453292519944444 && phi < -0.08726646259972222) ) return true;
  else if( (eta >= -0.609 && eta <-0.522) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= -0.522 && eta <-0.435) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= -0.435 && eta <-0.348) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= 0.0 && eta <0.087) && (phi >= 2.705260340591389 && phi < 2.792526803191111) ) return true;
  else if( (eta >= 0.0 && eta <0.087) && (phi >= 2.792526803191111 && phi < 2.879793265790833) ) return true;
  else if( (eta >= 0.0 && eta <0.087) && (phi >= 2.879793265790833 && phi < 2.9670597283905553) ) return true;
  else if( (eta >= 0.0 && eta <0.087) && (phi >= 2.9670597283905553 && phi < 3.0543261909902775) ) return true;
  else if( (eta >= 0.0 && eta <0.087) && (phi >= 3.0543261909902775 && phi < 3.1415926536) ) return true;
  else if( (eta >= 0.087 && eta <0.174) && (phi >= 2.705260340591389 && phi < 2.792526803191111) ) return true;
  else if( (eta >= 0.087 && eta <0.174) && (phi >= 2.792526803191111 && phi < 2.879793265790833) ) return true;
  else if( (eta >= 0.087 && eta <0.174) && (phi >= 2.879793265790833 && phi < 2.9670597283905553) ) return true;
  else if( (eta >= 0.087 && eta <0.174) && (phi >= 2.9670597283905553 && phi < 3.0543261909902775) ) return true;
  else if( (eta >= 0.087 && eta <0.174) && (phi >= 3.0543261909902775 && phi < 3.1415926536) ) return true;
  else if( (eta >= 0.174 && eta <0.261) && (phi >= 2.705260340591389 && phi < 2.792526803191111) ) return true;
  else if( (eta >= 0.174 && eta <0.261) && (phi >= 2.792526803191111 && phi < 2.879793265790833) ) return true;
  else if( (eta >= 0.174 && eta <0.261) && (phi >= 2.879793265790833 && phi < 2.9670597283905553) ) return true;
  else if( (eta >= 0.174 && eta <0.261) && (phi >= 2.9670597283905553 && phi < 3.0543261909902775) ) return true;
  else if( (eta >= 0.174 && eta <0.261) && (phi >= 3.0543261909902775 && phi < 3.1415926536) ) return true;
  else if( (eta >= 0.261 && eta <0.348) && (phi >= 2.705260340591389 && phi < 2.792526803191111) ) return true;
  else if( (eta >= 0.261 && eta <0.348) && (phi >= 2.792526803191111 && phi < 2.879793265790833) ) return true;
  else if( (eta >= 0.261 && eta <0.348) && (phi >= 2.879793265790833 && phi < 2.9670597283905553) ) return true;
  else if( (eta >= 0.261 && eta <0.348) && (phi >= 2.9670597283905553 && phi < 3.0543261909902775) ) return true;
  else if( (eta >= 0.261 && eta <0.348) && (phi >= 3.0543261909902775 && phi < 3.1415926536) ) return true;
  else if( (eta >= 0.348 && eta <0.435) && (phi >= 2.705260340591389 && phi < 2.792526803191111) ) return true;
  else if( (eta >= 0.348 && eta <0.435) && (phi >= 2.792526803191111 && phi < 2.879793265790833) ) return true;
  else if( (eta >= 0.348 && eta <0.435) && (phi >= 2.879793265790833 && phi < 2.9670597283905553) ) return true;
  else if( (eta >= 0.348 && eta <0.435) && (phi >= 2.9670597283905553 && phi < 3.0543261909902775) ) return true;
  else if( (eta >= 0.348 && eta <0.435) && (phi >= 3.0543261909902775 && phi < 3.1415926536) ) return true;
  else if( (eta >= 0.435 && eta <0.522) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= 0.435 && eta <0.522) && (phi >= 2.705260340591389 && phi < 2.792526803191111) ) return true;
  else if( (eta >= 0.435 && eta <0.522) && (phi >= 2.792526803191111 && phi < 2.879793265790833) ) return true;
  else if( (eta >= 0.435 && eta <0.522) && (phi >= 2.879793265790833 && phi < 2.9670597283905553) ) return true;
  else if( (eta >= 0.435 && eta <0.522) && (phi >= 2.9670597283905553 && phi < 3.0543261909902775) ) return true;
  else if( (eta >= 0.435 && eta <0.522) && (phi >= 3.0543261909902775 && phi < 3.1415926536) ) return true;
  else if( (eta >= 0.522 && eta <0.609) && (phi >= 2.705260340591389 && phi < 2.792526803191111) ) return true;
  else if( (eta >= 0.522 && eta <0.609) && (phi >= 2.792526803191111 && phi < 2.879793265790833) ) return true;
  else if( (eta >= 0.522 && eta <0.609) && (phi >= 2.879793265790833 && phi < 2.9670597283905553) ) return true;
  else if( (eta >= 0.522 && eta <0.609) && (phi >= 2.9670597283905553 && phi < 3.0543261909902775) ) return true;
  else if( (eta >= 0.522 && eta <0.609) && (phi >= 3.0543261909902775 && phi < 3.1415926536) ) return true;
  else if( (eta >= 0.609 && eta <0.696) && (phi >= -2.443460952792222 && phi < -2.3561944901925) ) return true;
  else if( (eta >= 0.609 && eta <0.696) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= 0.609 && eta <0.696) && (phi >= 2.705260340591389 && phi < 2.792526803191111) ) return true;
  else if( (eta >= 0.609 && eta <0.696) && (phi >= 2.792526803191111 && phi < 2.879793265790833) ) return true;
  else if( (eta >= 0.609 && eta <0.696) && (phi >= 2.879793265790833 && phi < 2.9670597283905553) ) return true;
  else if( (eta >= 0.609 && eta <0.696) && (phi >= 2.9670597283905553 && phi < 3.0543261909902775) ) return true;
  else if( (eta >= 0.609 && eta <0.696) && (phi >= 3.0543261909902775 && phi < 3.1415926536) ) return true;
  else if( (eta >= 0.696 && eta <0.783) && (phi >= -2.443460952792222 && phi < -2.3561944901925) ) return true;
  else if( (eta >= 0.696 && eta <0.783) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= 0.696 && eta <0.783) && (phi >= 2.705260340591389 && phi < 2.792526803191111) ) return true;
  else if( (eta >= 0.696 && eta <0.783) && (phi >= 2.792526803191111 && phi < 2.879793265790833) ) return true;
  else if( (eta >= 0.696 && eta <0.783) && (phi >= 2.879793265790833 && phi < 2.9670597283905553) ) return true;
  else if( (eta >= 0.696 && eta <0.783) && (phi >= 2.9670597283905553 && phi < 3.0543261909902775) ) return true;
  else if( (eta >= 0.696 && eta <0.783) && (phi >= 3.0543261909902775 && phi < 3.1415926536) ) return true;
  else if( (eta >= 0.783 && eta <0.879) && (phi >= -2.443460952792222 && phi < -2.3561944901925) ) return true;
  else if( (eta >= 0.783 && eta <0.879) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= 0.783 && eta <0.879) && (phi >= 2.705260340591389 && phi < 2.792526803191111) ) return true;
  else if( (eta >= 0.783 && eta <0.879) && (phi >= 2.792526803191111 && phi < 2.879793265790833) ) return true;
  else if( (eta >= 0.783 && eta <0.879) && (phi >= 2.879793265790833 && phi < 2.9670597283905553) ) return true;
  else if( (eta >= 0.783 && eta <0.879) && (phi >= 2.9670597283905553 && phi < 3.0543261909902775) ) return true;
  else if( (eta >= 0.783 && eta <0.879) && (phi >= 3.0543261909902775 && phi < 3.1415926536) ) return true;
  else if( (eta >= 0.879 && eta <0.957) && (phi >= -2.443460952792222 && phi < -2.3561944901925) ) return true;
  else if( (eta >= 0.879 && eta <0.957) && (phi >= 2.705260340591389 && phi < 2.792526803191111) ) return true;
  else if( (eta >= 0.879 && eta <0.957) && (phi >= 2.792526803191111 && phi < 2.879793265790833) ) return true;
  else if( (eta >= 0.879 && eta <0.957) && (phi >= 2.879793265790833 && phi < 2.9670597283905553) ) return true;
  else if( (eta >= 0.879 && eta <0.957) && (phi >= 2.9670597283905553 && phi < 3.0543261909902775) ) return true;
  else if( (eta >= 0.879 && eta <0.957) && (phi >= 3.0543261909902775 && phi < 3.1415926536) ) return true;
  else if( (eta >= 0.957 && eta <1.044) && (phi >= 2.705260340591389 && phi < 2.792526803191111) ) return true;
  else if( (eta >= 0.957 && eta <1.044) && (phi >= 2.792526803191111 && phi < 2.879793265790833) ) return true;
  else if( (eta >= 0.957 && eta <1.044) && (phi >= 2.879793265790833 && phi < 2.9670597283905553) ) return true;
  else if( (eta >= 0.957 && eta <1.044) && (phi >= 2.9670597283905553 && phi < 3.0543261909902775) ) return true;
  else if( (eta >= 0.957 && eta <1.044) && (phi >= 3.0543261909902775 && phi < 3.1415926536) ) return true;
  else if( (eta >= 1.044 && eta <1.131) && (phi >= -2.3561944901925 && phi < -2.2689280275927777) ) return true;
  else if( (eta >= 1.044 && eta <1.131) && (phi >= 2.705260340591389 && phi < 2.792526803191111) ) return true;
  else if( (eta >= 1.044 && eta <1.131) && (phi >= 2.792526803191111 && phi < 2.879793265790833) ) return true;
  else if( (eta >= 1.044 && eta <1.131) && (phi >= 2.879793265790833 && phi < 2.9670597283905553) ) return true;
  else if( (eta >= 1.044 && eta <1.131) && (phi >= 2.9670597283905553 && phi < 3.0543261909902775) ) return true;
  else if( (eta >= 1.044 && eta <1.131) && (phi >= 3.0543261909902775 && phi < 3.1415926536) ) return true;
  else if( (eta >= 1.131 && eta <1.218) && (phi >= 2.705260340591389 && phi < 2.792526803191111) ) return true;
  else if( (eta >= 1.131 && eta <1.218) && (phi >= 2.792526803191111 && phi < 2.879793265790833) ) return true;
  else if( (eta >= 1.131 && eta <1.218) && (phi >= 2.879793265790833 && phi < 2.9670597283905553) ) return true;
  else if( (eta >= 1.131 && eta <1.218) && (phi >= 2.9670597283905553 && phi < 3.0543261909902775) ) return true;
  else if( (eta >= 1.131 && eta <1.218) && (phi >= 3.0543261909902775 && phi < 3.1415926536) ) return true;
  else if( (eta >= 1.218 && eta <1.305) && (phi >= 2.705260340591389 && phi < 2.792526803191111) ) return true;
  else if( (eta >= 1.218 && eta <1.305) && (phi >= 2.792526803191111 && phi < 2.879793265790833) ) return true;
  else if( (eta >= 1.218 && eta <1.305) && (phi >= 2.879793265790833 && phi < 2.9670597283905553) ) return true;
  else if( (eta >= 1.218 && eta <1.305) && (phi >= 2.9670597283905553 && phi < 3.0543261909902775) ) return true;
  else if( (eta >= 1.218 && eta <1.305) && (phi >= 3.0543261909902775 && phi < 3.1415926536) ) return true;
  else if( (eta >= 1.305 && eta <1.392) && (phi >= -0.8726646259972222 && phi < -0.7853981633975) ) return true;
  else if( (eta >= 1.305 && eta <1.392) && (phi >= -0.7853981633975 && phi < -0.6981317007977778) ) return true;
  else if( (eta >= 1.305 && eta <1.392) && (phi >= -0.6981317007977778 && phi < -0.6108652381980555) ) return true;
  else if( (eta >= 1.305 && eta <1.392) && (phi >= -0.6108652381980555 && phi < -0.5235987755983333) ) return true;
  else if( (eta >= 1.305 && eta <1.392) && (phi >= 2.705260340591389 && phi < 2.792526803191111) ) return true;
  else if( (eta >= 1.305 && eta <1.392) && (phi >= 2.792526803191111 && phi < 2.879793265790833) ) return true;
  else if( (eta >= 1.305 && eta <1.392) && (phi >= 2.879793265790833 && phi < 2.9670597283905553) ) return true;
  else if( (eta >= 1.305 && eta <1.392) && (phi >= 2.9670597283905553 && phi < 3.0543261909902775) ) return true;
  else if( (eta >= 1.305 && eta <1.392) && (phi >= 3.0543261909902775 && phi < 3.1415926536) ) return true;
  else if( (eta >= 1.392 && eta <1.479) && (phi >= -0.8726646259972222 && phi < -0.7853981633975) ) return true;
  else if( (eta >= 1.392 && eta <1.479) && (phi >= -0.7853981633975 && phi < -0.6981317007977778) ) return true;
  else if( (eta >= 1.392 && eta <1.479) && (phi >= -0.6981317007977778 && phi < -0.6108652381980555) ) return true;
  else if( (eta >= 1.392 && eta <1.479) && (phi >= -0.6108652381980555 && phi < -0.5235987755983333) ) return true;
  else if( (eta >= 1.392 && eta <1.479) && (phi >= 2.705260340591389 && phi < 2.792526803191111) ) return true;
  else if( (eta >= 1.392 && eta <1.479) && (phi >= 2.792526803191111 && phi < 2.879793265790833) ) return true;
  else if( (eta >= 1.392 && eta <1.479) && (phi >= 2.879793265790833 && phi < 2.9670597283905553) ) return true;
  else if( (eta >= 1.392 && eta <1.479) && (phi >= 2.9670597283905553 && phi < 3.0543261909902775) ) return true;
  else if( (eta >= 1.392 && eta <1.479) && (phi >= 3.0543261909902775 && phi < 3.1415926536) ) return true;
  else if( (eta >= 1.479 && eta <1.566) && (phi >= -0.8726646259972222 && phi < -0.7853981633975) ) return true;
  else if( (eta >= 1.479 && eta <1.566) && (phi >= -0.7853981633975 && phi < -0.6981317007977778) ) return true;
  else if( (eta >= 1.479 && eta <1.566) && (phi >= -0.6981317007977778 && phi < -0.6108652381980555) ) return true;
  else if( (eta >= 1.479 && eta <1.566) && (phi >= -0.6108652381980555 && phi < -0.5235987755983333) ) return true;
  else if( (eta >= 1.566 && eta <1.653) && (phi >= -0.8726646259972222 && phi < -0.7853981633975) ) return true;
  else if( (eta >= 1.566 && eta <1.653) && (phi >= -0.7853981633975 && phi < -0.6981317007977778) ) return true;
  else if( (eta >= 1.566 && eta <1.653) && (phi >= -0.6981317007977778 && phi < -0.6108652381980555) ) return true;
  else if( (eta >= 1.566 && eta <1.653) && (phi >= -0.6108652381980555 && phi < -0.5235987755983333) ) return true;
  else if( (eta >= 1.653 && eta <1.74) && (phi >= -0.8726646259972222 && phi < -0.7853981633975) ) return true;
  else if( (eta >= 1.653 && eta <1.74) && (phi >= -0.7853981633975 && phi < -0.6981317007977778) ) return true;
  else if( (eta >= 1.653 && eta <1.74) && (phi >= -0.6981317007977778 && phi < -0.6108652381980555) ) return true;
  else if( (eta >= 1.653 && eta <1.74) && (phi >= -0.6108652381980555 && phi < -0.5235987755983333) ) return true;
  else if( (eta >= 1.74 && eta <1.83) && (phi >= -0.8726646259972222 && phi < -0.7853981633975) ) return true;
  else if( (eta >= 1.74 && eta <1.83) && (phi >= -0.7853981633975 && phi < -0.6981317007977778) ) return true;
  else if( (eta >= 1.74 && eta <1.83) && (phi >= -0.6981317007977778 && phi < -0.6108652381980555) ) return true;
  else if( (eta >= 1.74 && eta <1.83) && (phi >= -0.6108652381980555 && phi < -0.5235987755983333) ) return true;
  else if( (eta >= 1.83 && eta <1.93) && (phi >= -0.8726646259972222 && phi < -0.7853981633975) ) return true;
  else if( (eta >= 1.83 && eta <1.93) && (phi >= -0.7853981633975 && phi < -0.6981317007977778) ) return true;
  else if( (eta >= 1.83 && eta <1.93) && (phi >= -0.6981317007977778 && phi < -0.6108652381980555) ) return true;
  else if( (eta >= 1.83 && eta <1.93) && (phi >= -0.6108652381980555 && phi < -0.5235987755983333) ) return true;
  else if( (eta >= 1.93 && eta <2.043) && (phi >= -0.8726646259972222 && phi < -0.7853981633975) ) return true;
  else if( (eta >= 1.93 && eta <2.043) && (phi >= -0.7853981633975 && phi < -0.6981317007977778) ) return true;
  else if( (eta >= 1.93 && eta <2.043) && (phi >= -0.6981317007977778 && phi < -0.6108652381980555) ) return true;
  else if( (eta >= 1.93 && eta <2.043) && (phi >= -0.6108652381980555 && phi < -0.5235987755983333) ) return true;
  else if( (eta >= 2.043 && eta <2.172) && (phi >= -0.8726646259972222 && phi < -0.7853981633975) ) return true;
  else if( (eta >= 2.043 && eta <2.172) && (phi >= -0.7853981633975 && phi < -0.6981317007977778) ) return true;
  else if( (eta >= 2.043 && eta <2.172) && (phi >= -0.6981317007977778 && phi < -0.6108652381980555) ) return true;
  else if( (eta >= 2.043 && eta <2.172) && (phi >= -0.6108652381980555 && phi < -0.5235987755983333) ) return true;
  else if( (eta >= 2.172 && eta <2.322) && (phi >= -0.8726646259972222 && phi < -0.7853981633975) ) return true;
  else if( (eta >= 2.172 && eta <2.322) && (phi >= -0.7853981633975 && phi < -0.6981317007977778) ) return true;
  else if( (eta >= 2.172 && eta <2.322) && (phi >= -0.6981317007977778 && phi < -0.6108652381980555) ) return true;
  else if( (eta >= 2.172 && eta <2.322) && (phi >= -0.6108652381980555 && phi < -0.5235987755983333) ) return true;
  else if( (eta >= 2.322 && eta <2.5) && (phi >= -0.8726646259972222 && phi < -0.7853981633975) ) return true;
  else if( (eta >= 2.322 && eta <2.5) && (phi >= -0.7853981633975 && phi < -0.6981317007977778) ) return true;
  else if( (eta >= 2.322 && eta <2.5) && (phi >= -0.6981317007977778 && phi < -0.6108652381980555) ) return true;
  else if( (eta >= 2.322 && eta <2.5) && (phi >= -0.6108652381980555 && phi < -0.5235987755983333) ) return true;
  else if( (eta >= 2.5 && eta <2.65) && (phi >= -0.8726646259972222 && phi < -0.7853981633975) ) return true;
  else if( (eta >= 2.5 && eta <2.65) && (phi >= -0.7853981633975 && phi < -0.6981317007977778) ) return true;
  else if( (eta >= 2.5 && eta <2.65) && (phi >= -0.6981317007977778 && phi < -0.6108652381980555) ) return true;
  else if( (eta >= 2.5 && eta <2.65) && (phi >= -0.6108652381980555 && phi < -0.5235987755983333) ) return true;
  else if( (eta >= 2.65 && eta <2.853) && (phi >= -0.8726646259972222 && phi < -0.7853981633975) ) return true;
  else if( (eta >= 2.65 && eta <2.853) && (phi >= -0.7853981633975 && phi < -0.6981317007977778) ) return true;
  else if( (eta >= 2.65 && eta <2.853) && (phi >= -0.6981317007977778 && phi < -0.6108652381980555) ) return true;
  else if( (eta >= 2.65 && eta <2.853) && (phi >= -0.6108652381980555 && phi < -0.5235987755983333) ) return true;
  else if( (eta >= 2.853 && eta <2.964) && (phi >= -0.8726646259972222 && phi < -0.7853981633975) ) return true;
  else if( (eta >= 2.853 && eta <2.964) && (phi >= -0.7853981633975 && phi < -0.6981317007977778) ) return true;
  else if( (eta >= 2.853 && eta <2.964) && (phi >= -0.6981317007977778 && phi < -0.6108652381980555) ) return true;
  else if( (eta >= 2.853 && eta <2.964) && (phi >= -0.6108652381980555 && phi < -0.5235987755983333) ) return true;
  else if( (eta >= 2.853 && eta <2.964) && (phi >= 0.6981317007977778 && phi < 0.7853981633975) ) return true;
  else if( (eta >= 2.853 && eta <2.964) && (phi >= 0.7853981633975 && phi < 0.8726646259972222) ) return true;
  else return false;
...
bool HardcodedConditions::GetJetVetoMap2018( double eta, double phi ){
  if( (eta >= -2.964 && eta <-2.853) && (phi >= -1.570796326795 && phi < -1.4835298641952777) ) return true;
  else if( (eta >= -2.964 && eta <-2.853) && (phi >= -1.4835298641952777 && phi < -1.3962634015955555) ) return true;
  else if( (eta >= -2.964 && eta <-2.853) && (phi >= -1.3962634015955555 && phi < -1.3089969389958334) ) return true;
  else if( (eta >= -2.964 && eta <-2.853) && (phi >= -1.3089969389958334 && phi < -1.221730476396111) ) return true;
  else if( (eta >= -2.964 && eta <-2.853) && (phi >= -1.221730476396111 && phi < -1.1344640137963888) ) return true;
  else if( (eta >= -2.964 && eta <-2.853) && (phi >= -1.1344640137963888 && phi < -1.0471975511966667) ) return true;
  else if( (eta >= -2.964 && eta <-2.853) && (phi >= -1.0471975511966667 && phi < -0.9599310885969444) ) return true;
  else if( (eta >= -2.964 && eta <-2.853) && (phi >= -0.9599310885969444 && phi < -0.8726646259972222) ) return true;
  else if( (eta >= -2.853 && eta <-2.65) && (phi >= -1.570796326795 && phi < -1.4835298641952777) ) return true;
  else if( (eta >= -2.853 && eta <-2.65) && (phi >= -1.4835298641952777 && phi < -1.3962634015955555) ) return true;
  else if( (eta >= -2.853 && eta <-2.65) && (phi >= -1.3962634015955555 && phi < -1.3089969389958334) ) return true;
  else if( (eta >= -2.853 && eta <-2.65) && (phi >= -1.3089969389958334 && phi < -1.221730476396111) ) return true;
  else if( (eta >= -2.853 && eta <-2.65) && (phi >= -1.221730476396111 && phi < -1.1344640137963888) ) return true;
  else if( (eta >= -2.853 && eta <-2.65) && (phi >= -1.1344640137963888 && phi < -1.0471975511966667) ) return true;
  else if( (eta >= -2.853 && eta <-2.65) && (phi >= -1.0471975511966667 && phi < -0.9599310885969444) ) return true;
  else if( (eta >= -2.853 && eta <-2.65) && (phi >= -0.9599310885969444 && phi < -0.8726646259972222) ) return true;
  else if( (eta >= -2.65 && eta <-2.5) && (phi >= -1.570796326795 && phi < -1.4835298641952777) ) return true;
  else if( (eta >= -2.65 && eta <-2.5) && (phi >= -1.4835298641952777 && phi < -1.3962634015955555) ) return true;
  else if( (eta >= -2.65 && eta <-2.5) && (phi >= -1.3962634015955555 && phi < -1.3089969389958334) ) return true;
  else if( (eta >= -2.65 && eta <-2.5) && (phi >= -1.3089969389958334 && phi < -1.221730476396111) ) return true;
  else if( (eta >= -2.65 && eta <-2.5) && (phi >= -1.221730476396111 && phi < -1.1344640137963888) ) return true;
  else if( (eta >= -2.65 && eta <-2.5) && (phi >= -1.1344640137963888 && phi < -1.0471975511966667) ) return true;
  else if( (eta >= -2.65 && eta <-2.5) && (phi >= -1.0471975511966667 && phi < -0.9599310885969444) ) return true;
  else if( (eta >= -2.65 && eta <-2.5) && (phi >= -0.9599310885969444 && phi < -0.8726646259972222) ) return true;
  else if( (eta >= -2.5 && eta <-2.322) && (phi >= -1.570796326795 && phi < -1.4835298641952777) ) return true;
  else if( (eta >= -2.5 && eta <-2.322) && (phi >= -1.4835298641952777 && phi < -1.3962634015955555) ) return true;
  else if( (eta >= -2.5 && eta <-2.322) && (phi >= -1.3962634015955555 && phi < -1.3089969389958334) ) return true;
  else if( (eta >= -2.5 && eta <-2.322) && (phi >= -1.3089969389958334 && phi < -1.221730476396111) ) return true;
  else if( (eta >= -2.5 && eta <-2.322) && (phi >= -1.221730476396111 && phi < -1.1344640137963888) ) return true;
  else if( (eta >= -2.5 && eta <-2.322) && (phi >= -1.1344640137963888 && phi < -1.0471975511966667) ) return true;
  else if( (eta >= -2.5 && eta <-2.322) && (phi >= -1.0471975511966667 && phi < -0.9599310885969444) ) return true;
  else if( (eta >= -2.5 && eta <-2.322) && (phi >= -0.9599310885969444 && phi < -0.8726646259972222) ) return true;
  else if( (eta >= -2.322 && eta <-2.172) && (phi >= -1.570796326795 && phi < -1.4835298641952777) ) return true;
  else if( (eta >= -2.322 && eta <-2.172) && (phi >= -1.4835298641952777 && phi < -1.3962634015955555) ) return true;
  else if( (eta >= -2.322 && eta <-2.172) && (phi >= -1.3962634015955555 && phi < -1.3089969389958334) ) return true;
  else if( (eta >= -2.322 && eta <-2.172) && (phi >= -1.3089969389958334 && phi < -1.221730476396111) ) return true;
  else if( (eta >= -2.322 && eta <-2.172) && (phi >= -1.221730476396111 && phi < -1.1344640137963888) ) return true;
  else if( (eta >= -2.322 && eta <-2.172) && (phi >= -1.1344640137963888 && phi < -1.0471975511966667) ) return true;
  else if( (eta >= -2.322 && eta <-2.172) && (phi >= -1.0471975511966667 && phi < -0.9599310885969444) ) return true;
  else if( (eta >= -2.322 && eta <-2.172) && (phi >= -0.9599310885969444 && phi < -0.8726646259972222) ) return true;
  else if( (eta >= -2.172 && eta <-2.043) && (phi >= -1.570796326795 && phi < -1.4835298641952777) ) return true;
  else if( (eta >= -2.172 && eta <-2.043) && (phi >= -1.4835298641952777 && phi < -1.3962634015955555) ) return true;
  else if( (eta >= -2.172 && eta <-2.043) && (phi >= -1.3962634015955555 && phi < -1.3089969389958334) ) return true;
  else if( (eta >= -2.172 && eta <-2.043) && (phi >= -1.3089969389958334 && phi < -1.221730476396111) ) return true;
  else if( (eta >= -2.172 && eta <-2.043) && (phi >= -1.221730476396111 && phi < -1.1344640137963888) ) return true;
  else if( (eta >= -2.172 && eta <-2.043) && (phi >= -1.1344640137963888 && phi < -1.0471975511966667) ) return true;
  else if( (eta >= -2.172 && eta <-2.043) && (phi >= -1.0471975511966667 && phi < -0.9599310885969444) ) return true;
  else if( (eta >= -2.172 && eta <-2.043) && (phi >= -0.9599310885969444 && phi < -0.8726646259972222) ) return true;
  else if( (eta >= -2.043 && eta <-1.93) && (phi >= -1.570796326795 && phi < -1.4835298641952777) ) return true;
  else if( (eta >= -2.043 && eta <-1.93) && (phi >= -1.4835298641952777 && phi < -1.3962634015955555) ) return true;
  else if( (eta >= -2.043 && eta <-1.93) && (phi >= -1.3962634015955555 && phi < -1.3089969389958334) ) return true;
  else if( (eta >= -2.043 && eta <-1.93) && (phi >= -1.3089969389958334 && phi < -1.221730476396111) ) return true;
  else if( (eta >= -2.043 && eta <-1.93) && (phi >= -1.221730476396111 && phi < -1.1344640137963888) ) return true;
  else if( (eta >= -2.043 && eta <-1.93) && (phi >= -1.1344640137963888 && phi < -1.0471975511966667) ) return true;
  else if( (eta >= -2.043 && eta <-1.93) && (phi >= -1.0471975511966667 && phi < -0.9599310885969444) ) return true;
  else if( (eta >= -2.043 && eta <-1.93) && (phi >= -0.9599310885969444 && phi < -0.8726646259972222) ) return true;
  else if( (eta >= -1.93 && eta <-1.83) && (phi >= -1.570796326795 && phi < -1.4835298641952777) ) return true;
  else if( (eta >= -1.93 && eta <-1.83) && (phi >= -1.4835298641952777 && phi < -1.3962634015955555) ) return true;
  else if( (eta >= -1.93 && eta <-1.83) && (phi >= -1.3962634015955555 && phi < -1.3089969389958334) ) return true;
  else if( (eta >= -1.93 && eta <-1.83) && (phi >= -1.3089969389958334 && phi < -1.221730476396111) ) return true;
  else if( (eta >= -1.93 && eta <-1.83) && (phi >= -1.221730476396111 && phi < -1.1344640137963888) ) return true;
  else if( (eta >= -1.93 && eta <-1.83) && (phi >= -1.1344640137963888 && phi < -1.0471975511966667) ) return true;
  else if( (eta >= -1.93 && eta <-1.83) && (phi >= -1.0471975511966667 && phi < -0.9599310885969444) ) return true;
  else if( (eta >= -1.93 && eta <-1.83) && (phi >= -0.9599310885969444 && phi < -0.8726646259972222) ) return true;
  else if( (eta >= -1.83 && eta <-1.74) && (phi >= -1.570796326795 && phi < -1.4835298641952777) ) return true;
  else if( (eta >= -1.83 && eta <-1.74) && (phi >= -1.4835298641952777 && phi < -1.3962634015955555) ) return true;
  else if( (eta >= -1.83 && eta <-1.74) && (phi >= -1.3962634015955555 && phi < -1.3089969389958334) ) return true;
  else if( (eta >= -1.83 && eta <-1.74) && (phi >= -1.3089969389958334 && phi < -1.221730476396111) ) return true;
  else if( (eta >= -1.83 && eta <-1.74) && (phi >= -1.221730476396111 && phi < -1.1344640137963888) ) return true;
  else if( (eta >= -1.83 && eta <-1.74) && (phi >= -1.1344640137963888 && phi < -1.0471975511966667) ) return true;
  else if( (eta >= -1.83 && eta <-1.74) && (phi >= -1.0471975511966667 && phi < -0.9599310885969444) ) return true;
  else if( (eta >= -1.83 && eta <-1.74) && (phi >= -0.9599310885969444 && phi < -0.8726646259972222) ) return true;
  else if( (eta >= -1.74 && eta <-1.653) && (phi >= -1.570796326795 && phi < -1.4835298641952777) ) return true;
  else if( (eta >= -1.74 && eta <-1.653) && (phi >= -1.4835298641952777 && phi < -1.3962634015955555) ) return true;
  else if( (eta >= -1.74 && eta <-1.653) && (phi >= -1.3962634015955555 && phi < -1.3089969389958334) ) return true;
  else if( (eta >= -1.74 && eta <-1.653) && (phi >= -1.3089969389958334 && phi < -1.221730476396111) ) return true;
  else if( (eta >= -1.74 && eta <-1.653) && (phi >= -1.221730476396111 && phi < -1.1344640137963888) ) return true;
  else if( (eta >= -1.74 && eta <-1.653) && (phi >= -1.1344640137963888 && phi < -1.0471975511966667) ) return true;
  else if( (eta >= -1.74 && eta <-1.653) && (phi >= -1.0471975511966667 && phi < -0.9599310885969444) ) return true;
  else if( (eta >= -1.74 && eta <-1.653) && (phi >= -0.9599310885969444 && phi < -0.8726646259972222) ) return true;
  else if( (eta >= -1.653 && eta <-1.566) && (phi >= -1.570796326795 && phi < -1.4835298641952777) ) return true;
  else if( (eta >= -1.653 && eta <-1.566) && (phi >= -1.4835298641952777 && phi < -1.3962634015955555) ) return true;
  else if( (eta >= -1.653 && eta <-1.566) && (phi >= -1.3962634015955555 && phi < -1.3089969389958334) ) return true;
  else if( (eta >= -1.653 && eta <-1.566) && (phi >= -1.3089969389958334 && phi < -1.221730476396111) ) return true;
  else if( (eta >= -1.653 && eta <-1.566) && (phi >= -1.221730476396111 && phi < -1.1344640137963888) ) return true;
  else if( (eta >= -1.653 && eta <-1.566) && (phi >= -1.1344640137963888 && phi < -1.0471975511966667) ) return true;
  else if( (eta >= -1.653 && eta <-1.566) && (phi >= -1.0471975511966667 && phi < -0.9599310885969444) ) return true;
  else if( (eta >= -1.653 && eta <-1.566) && (phi >= -0.9599310885969444 && phi < -0.8726646259972222) ) return true;
  else if( (eta >= -1.566 && eta <-1.479) && (phi >= -1.570796326795 && phi < -1.4835298641952777) ) return true;
  else if( (eta >= -1.566 && eta <-1.479) && (phi >= -1.4835298641952777 && phi < -1.3962634015955555) ) return true;
  else if( (eta >= -1.566 && eta <-1.479) && (phi >= -1.3962634015955555 && phi < -1.3089969389958334) ) return true;
  else if( (eta >= -1.566 && eta <-1.479) && (phi >= -1.3089969389958334 && phi < -1.221730476396111) ) return true;
  else if( (eta >= -1.566 && eta <-1.479) && (phi >= -1.221730476396111 && phi < -1.1344640137963888) ) return true;
  else if( (eta >= -1.566 && eta <-1.479) && (phi >= -1.1344640137963888 && phi < -1.0471975511966667) ) return true;
  else if( (eta >= -1.566 && eta <-1.479) && (phi >= -1.0471975511966667 && phi < -0.9599310885969444) ) return true;
  else if( (eta >= -1.566 && eta <-1.479) && (phi >= -0.9599310885969444 && phi < -0.8726646259972222) ) return true;
  else if( (eta >= -1.479 && eta <-1.392) && (phi >= -1.570796326795 && phi < -1.4835298641952777) ) return true;
  else if( (eta >= -1.479 && eta <-1.392) && (phi >= -1.4835298641952777 && phi < -1.3962634015955555) ) return true;
  else if( (eta >= -1.479 && eta <-1.392) && (phi >= -1.3962634015955555 && phi < -1.3089969389958334) ) return true;
  else if( (eta >= -1.479 && eta <-1.392) && (phi >= -1.3089969389958334 && phi < -1.221730476396111) ) return true;
  else if( (eta >= -1.479 && eta <-1.392) && (phi >= -1.221730476396111 && phi < -1.1344640137963888) ) return true;
  else if( (eta >= -1.479 && eta <-1.392) && (phi >= -1.1344640137963888 && phi < -1.0471975511966667) ) return true;
  else if( (eta >= -1.479 && eta <-1.392) && (phi >= -1.0471975511966667 && phi < -0.9599310885969444) ) return true;
  else if( (eta >= -1.479 && eta <-1.392) && (phi >= -0.9599310885969444 && phi < -0.8726646259972222) ) return true;
  else if( (eta >= -1.392 && eta <-1.305) && (phi >= -1.570796326795 && phi < -1.4835298641952777) ) return true;
  else if( (eta >= -1.392 && eta <-1.305) && (phi >= -1.4835298641952777 && phi < -1.3962634015955555) ) return true;
  else if( (eta >= -1.392 && eta <-1.305) && (phi >= -1.3962634015955555 && phi < -1.3089969389958334) ) return true;
  else if( (eta >= -1.392 && eta <-1.305) && (phi >= -1.3089969389958334 && phi < -1.221730476396111) ) return true;
  else if( (eta >= -1.392 && eta <-1.305) && (phi >= -1.221730476396111 && phi < -1.1344640137963888) ) return true;
  else if( (eta >= -1.392 && eta <-1.305) && (phi >= -1.1344640137963888 && phi < -1.0471975511966667) ) return true;
  else if( (eta >= -1.392 && eta <-1.305) && (phi >= -1.0471975511966667 && phi < -0.9599310885969444) ) return true;
  else if( (eta >= -1.392 && eta <-1.305) && (phi >= -0.9599310885969444 && phi < -0.8726646259972222) ) return true;
  else if( (eta >= -1.131 && eta <-1.044) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= 0.0 && eta <0.087) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= 0.0 && eta <0.087) && (phi >= 0.5235987755983333 && phi < 0.6108652381980555) ) return true;
  else if( (eta >= 0.0 && eta <0.087) && (phi >= 0.6108652381980555 && phi < 0.6981317007977778) ) return true;
  else if( (eta >= 0.0 && eta <0.087) && (phi >= 0.6981317007977778 && phi < 0.7853981633975) ) return true;
  else if( (eta >= 0.087 && eta <0.174) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= 0.087 && eta <0.174) && (phi >= 0.5235987755983333 && phi < 0.6108652381980555) ) return true;
  else if( (eta >= 0.087 && eta <0.174) && (phi >= 0.6108652381980555 && phi < 0.6981317007977778) ) return true;
  else if( (eta >= 0.087 && eta <0.174) && (phi >= 0.6981317007977778 && phi < 0.7853981633975) ) return true;
  else if( (eta >= 0.174 && eta <0.261) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= 0.174 && eta <0.261) && (phi >= 0.5235987755983333 && phi < 0.6108652381980555) ) return true;
  else if( (eta >= 0.174 && eta <0.261) && (phi >= 0.6108652381980555 && phi < 0.6981317007977778) ) return true;
  else if( (eta >= 0.174 && eta <0.261) && (phi >= 0.6981317007977778 && phi < 0.7853981633975) ) return true;
  else if( (eta >= 0.261 && eta <0.348) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= 0.261 && eta <0.348) && (phi >= 0.5235987755983333 && phi < 0.6108652381980555) ) return true;
  else if( (eta >= 0.261 && eta <0.348) && (phi >= 0.6108652381980555 && phi < 0.6981317007977778) ) return true;
  else if( (eta >= 0.261 && eta <0.348) && (phi >= 0.6981317007977778 && phi < 0.7853981633975) ) return true;
  else if( (eta >= 0.348 && eta <0.435) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= 0.348 && eta <0.435) && (phi >= 0.5235987755983333 && phi < 0.6108652381980555) ) return true;
  else if( (eta >= 0.348 && eta <0.435) && (phi >= 0.6108652381980555 && phi < 0.6981317007977778) ) return true;
  else if( (eta >= 0.348 && eta <0.435) && (phi >= 0.6981317007977778 && phi < 0.7853981633975) ) return true;
  else if( (eta >= 0.435 && eta <0.522) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= 0.435 && eta <0.522) && (phi >= 0.5235987755983333 && phi < 0.6108652381980555) ) return true;
  else if( (eta >= 0.435 && eta <0.522) && (phi >= 0.6108652381980555 && phi < 0.6981317007977778) ) return true;
  else if( (eta >= 0.435 && eta <0.522) && (phi >= 0.6981317007977778 && phi < 0.7853981633975) ) return true;
  else if( (eta >= 0.522 && eta <0.609) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= 0.522 && eta <0.609) && (phi >= 0.5235987755983333 && phi < 0.6108652381980555) ) return true;
  else if( (eta >= 0.522 && eta <0.609) && (phi >= 0.6108652381980555 && phi < 0.6981317007977778) ) return true;
  else if( (eta >= 0.522 && eta <0.609) && (phi >= 0.6981317007977778 && phi < 0.7853981633975) ) return true;
  else if( (eta >= 0.609 && eta <0.696) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= 0.609 && eta <0.696) && (phi >= 0.5235987755983333 && phi < 0.6108652381980555) ) return true;
  else if( (eta >= 0.609 && eta <0.696) && (phi >= 0.6108652381980555 && phi < 0.6981317007977778) ) return true;
  else if( (eta >= 0.609 && eta <0.696) && (phi >= 0.6981317007977778 && phi < 0.7853981633975) ) return true;
  else if( (eta >= 0.696 && eta <0.783) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= 0.696 && eta <0.783) && (phi >= 0.5235987755983333 && phi < 0.6108652381980555) ) return true;
  else if( (eta >= 0.696 && eta <0.783) && (phi >= 0.6108652381980555 && phi < 0.6981317007977778) ) return true;
  else if( (eta >= 0.696 && eta <0.783) && (phi >= 0.6981317007977778 && phi < 0.7853981633975) ) return true;
  else if( (eta >= 0.783 && eta <0.879) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= 0.783 && eta <0.879) && (phi >= 0.5235987755983333 && phi < 0.6108652381980555) ) return true;
  else if( (eta >= 0.783 && eta <0.879) && (phi >= 0.6108652381980555 && phi < 0.6981317007977778) ) return true;
  else if( (eta >= 0.783 && eta <0.879) && (phi >= 0.6981317007977778 && phi < 0.7853981633975) ) return true;
  else if( (eta >= 0.879 && eta <0.957) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= 0.879 && eta <0.957) && (phi >= 0.5235987755983333 && phi < 0.6108652381980555) ) return true;
  else if( (eta >= 0.879 && eta <0.957) && (phi >= 0.6108652381980555 && phi < 0.6981317007977778) ) return true;
  else if( (eta >= 0.879 && eta <0.957) && (phi >= 0.6981317007977778 && phi < 0.7853981633975) ) return true;
  else if( (eta >= 0.957 && eta <1.044) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= 0.957 && eta <1.044) && (phi >= 0.5235987755983333 && phi < 0.6108652381980555) ) return true;
  else if( (eta >= 0.957 && eta <1.044) && (phi >= 0.6108652381980555 && phi < 0.6981317007977778) ) return true;
  else if( (eta >= 0.957 && eta <1.044) && (phi >= 0.6981317007977778 && phi < 0.7853981633975) ) return true;
  else if( (eta >= 1.044 && eta <1.131) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= 1.044 && eta <1.131) && (phi >= 0.5235987755983333 && phi < 0.6108652381980555) ) return true;
  else if( (eta >= 1.044 && eta <1.131) && (phi >= 0.6108652381980555 && phi < 0.6981317007977778) ) return true;
  else if( (eta >= 1.044 && eta <1.131) && (phi >= 0.6981317007977778 && phi < 0.7853981633975) ) return true;
  else if( (eta >= 1.131 && eta <1.218) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= 1.131 && eta <1.218) && (phi >= 0.5235987755983333 && phi < 0.6108652381980555) ) return true;
  else if( (eta >= 1.131 && eta <1.218) && (phi >= 0.6108652381980555 && phi < 0.6981317007977778) ) return true;
  else if( (eta >= 1.131 && eta <1.218) && (phi >= 0.6981317007977778 && phi < 0.7853981633975) ) return true;
  else if( (eta >= 1.218 && eta <1.305) && (phi >= 0.4363323129986111 && phi < 0.5235987755983333) ) return true;
  else if( (eta >= 1.218 && eta <1.305) && (phi >= 0.5235987755983333 && phi < 0.6108652381980555) ) return true;
  else if( (eta >= 1.218 && eta <1.305) && (phi >= 0.6108652381980555 && phi < 0.6981317007977778) ) return true;
  else if( (eta >= 1.218 && eta <1.305) && (phi >= 0.6981317007977778 && phi < 0.7853981633975) ) return true;
  else if( (eta >= 1.566 && eta <1.653) && (phi >= -1.3089969389958334 && phi < -1.221730476396111) ) return true;
  else if( (eta >= 1.653 && eta <1.74) && (phi >= -1.3089969389958334 && phi < -1.221730476396111) ) return true;
  else if( (eta >= 2.5 && eta <2.65) && (phi >= -0.5235987755983333 && phi < -0.4363323129986111) ) return true;
  else return false;
