...
void HardcodedConditions::GetTtaggingEff2017(double pt, double *eff, std::string sample, int massIndex){
   ...
   double ttbarEff[Nbin] = {0.544,0.799,0.877, 0.901, 0.912, 0.917, 0.922, 0.926, 0.930, 0.935, 0.931};
   double STEff[Nbin] = {0.500,0.778,0.861, 0.890, 0.902, 0.912, 0.911, 0.906, 0.918, 0.911, 0.914};
...
//    double STEff[NbinB]  = {0.617, 0.712, 0.679, 0.642, 0.622, 0.604, 0.592, 0.593, 0.602, 0.573, 0.488, 0.600}; // single top (s and t channel had 0 boosted tops)
    ...
    double x53x53Eff[10][Nbin] = {//X53X53
     ...
     {0.661, 0.820, 0.867, 0.884, 0.904, 0.919, 0.926, 0.936, 0.941, 0.944, 0.941},//1500R
...
void HardcodedConditions::GetTtaggingEff2018(double pt, double *eff, std::string sample, int massIndex){
   const int Nbin = 11;
   double ptMins[Nbin] = {300,350,400,450,500,550,600,700,800,1000,1200};
   double ttbarEff[Nbin] = {0.527, 0.788, 0.869, 0.895, 0.906, 0.913, 0.917, 0.921, 0.923, 0.926, 0.924};
   double STEff[Nbin] = {0.496, 0.772, 0.861, 0.885, 0.896, 0.905, 0.905, 0.914, 0.918, 0.911, 0.892}; 

    double x53x53Eff[12][Nbin] = {//X53X53
     {0.617, 0.824, 0.896, 0.919, 0.927, 0.925, 0.932, 0.937, 0.941, 0.938, 0.918},//700
     {0.650, 0.833, 0.890, 0.916, 0.925, 0.934, 0.933, 0.940, 0.938, 0.929, 0.948},//800
     {0.676, 0.827, 0.887, 0.913, 0.927, 0.933, 0.936, 0.933, 0.943, 0.937, 0.921},//900R
     ...
     {0.675, 0.821, 0.870, 0.898, 0.912, 0.922, 0.932, 0.938, 0.938, 0.943, 0.942},//1200R
     ...
     {0.683, 0.804, 0.867, 0.889, 0.901, 0.913, 0.927, 0.937, 0.940, 0.937, 0.940},//1500R
    ...
    double x53x53EffH[30][Nbin] = {//X53X53
     ...
     {0.680, 0.827, 0.873, 0.899, 0.914, 0.919, 0.928, 0.932, 0.944, 0.953, 0.922},
     ...
     {0.704, 0.819, 0.873, 0.895, 0.913, 0.925, 0.929, 0.933, 0.951, 0.952, 0.947},
     {0.707, 0.816, 0.867, 0.891, 0.902, 0.907, 0.919, 0.924, 0.927, 0.929, 0.939},
...
void HardcodedConditions::GetWtaggingSF(double pt, double *PNsf, double *PNsfup, double *PNsfdn, std::string year){
  ...
  *PNsfdn = 1.000;
  ...
  else if (year=="2016") GetWtaggingSF2017(pt, PNsf, PNsfup, PNsfdn);
